...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async AnalyzePageType(
        raw_text: string,base_url: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.PageAnalysis> {
          try {
          ...
          const __stream__ = this.stream.AnalyzePageType(
          raw_text,base_url,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "AnalyzePageType",
            {
            "raw_text": raw_text,"base_url": base_url
            },
            ...
            return __raw__.parsed(false) as types.PageAnalysis
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ExtractJobPosting(
          raw_text,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.JobPosting
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ExtractURLs(
          text,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            raw_text: string,base_url: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.PageAnalysis, types.PageAnalysis>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AnalyzePageType", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.PageAnalysis, types.PageAnalysis>(
                  __raw__,
                  (a): partial_types.PageAnalysis => a,
                  (a): types.PageAnalysis => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            raw_text: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.JobPosting, types.JobPosting>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractJobPosting", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.JobPosting, types.JobPosting>(
                  __raw__,
                  (a): partial_types.JobPosting => a,
                  (a): types.JobPosting => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for ExtractURLs", error);
              }
              }
              };
              }
